...
@NamedQueries({
    ...
    , @NamedQuery(name = "Aprendices.findByFkCurso", query = "SELECT a FROM Aprendices a WHERE a.fkCurso.idCurso  = :idCurso")        
    , @NamedQuery(name = "Aprendices.findByJornada", query = "SELECT a FROM Aprendices a WHERE a.jornada = :jornada")})
public class Aprendices implements Serializable {
    ...
    public String toString() {
        return "com.adsi.rest.Aprendices[ idAprendices=" + idAprendices + " ]";
    }
